...
# Stages
STAGE_1 = ["A_tot", "A_dis", "V_IC", "alpha_loss"]
STAGE_2 = ["Ua_suc_ref", "Ua_dis_ref", "Ua_amb"]
STAGE_3 = ["A_tot", "A_dis", "V_IC", "alpha_loss", "Ua_suc_ref", "Ua_dis_ref", "Ua_amb"]
...
def run_least_squares_for_names(
    ...
    print(f"  use_t_dis : {use_t_dis} (w_T_dis={w_t_dis})")
...
def main():
    ap = argparse.ArgumentParser(
        description="Fit Molinaroli parameters (SciPy least_squares), optional staged fit + x_scale=jac"
    )
