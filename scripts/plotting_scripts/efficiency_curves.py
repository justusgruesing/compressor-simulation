...
#   python scripts/plotting_scripts/efficiency_curves.py --params_csv_oil1 results/final_results/Modified_LPG68/Fitting/fitted_params_lpg68_modified_ga_2026-03-22_185546.csv --params_csv_oil2 results/final_results/Modified_LPG100/Fitting/fitted_params_lpg100_modified_ga_2026-03-28_092941.csv --oil1 LPG68 --oil2 LPG100 --metric all --vary T_cond --T_evap 0 10 20 --N_rpm 3600 --SH_K 10
#
...
def main():
    ...
    needs_oil_name = m in ("mod", "modified")
    ...
    for metric_name in metrics_to_plot:
        ...
        out_path = (
            out_dir
            / f"efficiency_{metric_name}_{args.vary}_{args.oil1.lower()}_vs_{args.oil2.lower()}_{stamp}.{args.out_format}"
        )
    ...
    # Save the simulation data once (contains all metrics)
    data_stem = (
        f"efficiency_data_{args.vary}_{args.oil1.lower()}_vs_{args.oil2.lower()}_{stamp}"
    )
